...
SYSTEM_MSG = {
    ...
    "content": (
        ...
        "- For visualization requests, call create_plotly_chart_from_output_file using the query_* tool result payload.\n"
        ...
        "- Example D: For 'plot flow vs time', run query_* first, then call create_plotly_chart_from_output_file"

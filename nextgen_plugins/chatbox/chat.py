...
class NRDSChat(base.DataSource):
    container = "python"
    version = "0.0.1"
    name = "nrds_s3_chat"
    visualization_tags = [
    ...
    visualization_label = "NextGen Live Chat"
    ...
    async def start_chat(self, request_id=None):
        try:
        ...
        while True:
            ...
            had_error, last_err, failed_signatures = await self.process_tool_calls(tool_calls, messages)
            ...
            if had_error and last_err:
                ...
                for attempt in range(1, MAX_TOOL_REPAIR_ATTEMPTS + 1):
                    ...
                    had_error, last_err, failed_signatures = await self.process_tool_calls(

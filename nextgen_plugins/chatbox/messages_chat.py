...
SYSTEM_MSG = {
    ...
    "content": (
        ...
        "- Chat mode only: do NOT call plotly/chart-creation tools.\n"
        "- If a user asks for a plot, return the queried data summary and suggest using the chart endpoint.\n"
        ...
        "- Example D: For 'plot flow vs time' in chat mode, run query_* and return a concise data summary; "
        "do not call plotly tools.\n\n"
